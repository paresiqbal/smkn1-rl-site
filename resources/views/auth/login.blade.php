        ...
        <form method="POST" action="{{ route('show.login') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="email" id="email" name="email"
                    class="w-full border-black border-2 p-2.5 focus:outline-none focus:shadow-[2px_2px_0px_rgba(0,0,0,1)] focus:bg-yellow-300 active:shadow-[2px_2px_0px_rgba(0,0,0,1)]"
                    required>
            </div>
            <div class="form-group mb-4">
