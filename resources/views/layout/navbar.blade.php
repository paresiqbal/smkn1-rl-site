<nav class=" p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-6">
            ...
            <div class="relative group">
                <a href="#" id="showcase-desktop-toggle"
                    class="inline-flex items-center text-black dark:text-white">
                    Showcase
                ...
                <div id="showcase-desktop-dropdown" class="absolute hidden  shadow-lg mt-1">
                    <a href="#" class="block px-4 py-2 text-black dark:text-white">Gallery</a>
                    <a href="#" class="block px-4 py-2 text-black dark:text-white">Projects</a>
    ...
    <div id="mobile-menu" class="md:hidden hidden transition duration-300 ">
        <a href="#" class="block p-2 text-black dark:text-white">Home</a>
        <a href="#" class="block p-2 text-black dark:text-white">News</a>
        <div class="relative">
